...
-   group_by and summarize to calculate the mean pct of Trump 2020 vote (pct_r\_2020) by urban/rural categories (rural_urban)
...
-   group/summarize to calculate the mean pct of Trump 2020 vote by counties above or below the national average for college graduates (pct_ed_college_all_abovebelow_natl). Note we're looking for the entire country here.
